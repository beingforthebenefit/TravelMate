...
export default function DashboardPage() {
    ...
    const cards = [
        ...
        { id: 2, title: "Trip to Tokyo", description: "Experience the vibrant culture of Tokyo." },
        { id: 3, title: "Trip to New York", description: "Discover the city that never sleeps." },
    ];
        ...
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
            ...
            <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    {cards.map(card => (
                        <div key={card.id} className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
